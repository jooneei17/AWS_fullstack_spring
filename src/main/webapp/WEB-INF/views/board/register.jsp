           ...
           <div class="card-body">
              <form method="post">
				  ...
				  <div class="form-group">
				    ...
				    <textarea rows="15" class="form-control" id="comment" name="content"></textarea>
				    
				  </div>
				  <div class="form-group">
				    <label for="writer">writer  </label>
				    <input type="text" class="form-control" id="writer" placeholder="Enter writer" id="writer" name="writer">
				  </div>
