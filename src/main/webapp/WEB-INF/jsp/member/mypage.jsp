	                ...
	                <form method="post" autocomplete="off" class="form-horizontal form-material">
	                    <div class="mb-3 mt-3 form-group">
		                    <div class="d-flex justify-content-between">
		                   		<h4 class="d-inline-block">${member.id}</h4> <a href="#" class="btn btn-secondary btn-sm ms-3">비밀번호 변경</a>
		                    </div>
		                    <div class="d-flex justify-content-between">
	                    ...
	                    <div class="mb-3">
		                    ...
		                    <div class="input-group">
		                    	<input type="text" class="form-control" id="addr" placeholder="" name="addr" readonly value="${member.addr}">
		                    </div>
		                    <input type="text" class="form-control mt-3" id="addrDetail" placeholder="상세주소" name="addrDetail" readonly value="${member.addrDetail}">
	                    </div>
	                    <div class="mb-3">
